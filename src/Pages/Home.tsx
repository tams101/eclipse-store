    ...
    <>
      <section className="px-3 py-5 bg-stone-50  lg:py-10 flex justify-center items-center">
        <div className="flex flex-col justify-center items-center h-fit gap-5 md:gap-20 md:flex-row">
          <div>
            <img className="rounded-md object-contain h-[200px] lg:h-[350px]" src="/assets/hero.jpg" alt="Someone browsing clothes on a rack" />
          </div>
      ...
      <section className="grid grid-cols-1 gap-5 p-8 place-items-center md:grid-cols-2 lg:grid-cols-4">
        <Link to="/womens">
          <div className="relative hover:-translate-y-1 hover:scale-105 duration-300">
            <img className="w-[200px] h-[200px] lg:w-[300px] lg:h-[300px] object-cover opacity-90" src="assets/womens.jpg" alt="Woman posing showing the gold bracelets around her wrists" />
        ...
        <Link to="/mens">
          <div className="relative hover:-translate-y-1 hover:scale-105 duration-300">
            <img className="w-[200px] h-[200px] lg:w-[300px] lg:h-[300px] object-cover opacity-90"src="/assets/mens.jpg" alt="A young man sat down on a wall looking into the distance" />
        ...
        <Link to="/jewelery">
          <div className="relative hover:-translate-y-1 hover:scale-105 duration-300">
            <img className="w-[200px] h-[200px] lg:w-[300px] lg:h-[300px] object-cover opacity-90" src="/assets/jewellery.jpg" alt="Different types of jewellery laid on a table" />
        ...
        <Link to="/electronics">
          <div className="relative hover:-translate-y-1 hover:scale-105 duration-300">
            <img className="w-[200px] h-[200px] lg:w-[300px] lg:h-[300px] object-cover opacity-90" src="/assets/electronics.jpg" alt="Electronic items including an iPhone laid out neatly on a white table" />
